...
# generator test directory needs to be run. It compares the state of the PR branch
...
if os.getenv("TESTLANG"):
    dir = "generators/" + os.getenv("TESTLANG") + "/"
...
# Forced generator run in addition to other tests
