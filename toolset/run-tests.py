...
def main(argv=None):
    ...
    parser = argparse.ArgumentParser(
        description="Install or run the Static Site Generator Benchmarks test suite.",
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='Audits generator tests for inconsistencies')
    parser.add_argument(
        '--clean',
        action='store_true',
        default=False,
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='Initialize a new generator test')
    parser.add_argument(
        '--quiet',
        action='store_true',
        default=False,
    ...
    parser.add_argument(
        ...
        nargs='+',
        dest='test_dir',
        help='name of generator directory containing all tests to run')
    parser.add_argument(
        '--test-lang',
        nargs='+',
        dest='test_lang',
    ...
    parser.add_argument(
        '--file-size',
        default=10,
        help='Content file size to beanchmark')
    parser.add_argument(
        '--file-number',
        default=1000,
        help='Number of content files to beanchmark')
    parser.add_argument(
        '--list-tests',
        action='store_true',
        default=False,
