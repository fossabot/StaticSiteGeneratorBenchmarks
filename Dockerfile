...
ENV PYTHONPATH /StaticSiteGeneratorBenchmarks
ENV FWROOT /StaticSiteGeneratorBenchmarks

ENTRYPOINT ["python", "/StaticSiteGeneratorBenchmarks/toolset/run-tests.py"]
